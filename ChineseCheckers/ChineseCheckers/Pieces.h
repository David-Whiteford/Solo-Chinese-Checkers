...
public:
	...
	void setNeighboursRays(Raycast* t_ray)
	{
		m_neighboursRays.push_back(t_ray);
	}
	std::vector<Raycast*> getNeighboursRays()
	{
		return m_neighboursRays;
	}
	void draw()
	{
...
private:
	...
	std::vector<Raycast*> m_neighboursRays;
};
